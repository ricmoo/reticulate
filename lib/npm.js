...
function createTarball(path) {
    ...
    const integrity = crypto_1.default.createHash("sha512").update(tarball).digest("base64");
    ...
    publish(path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return _retryOtp(options, () => __awaiter(this, void 0, void 0, function* () {
                return yield libnpmpublish_1.publish(manifest, tarball, options);
            }));
        });
    }
...
fs_1.default.writeFileSync("./test-tarball.tgz", tarball);
