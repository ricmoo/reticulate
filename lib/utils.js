...
exports.walk = exports.getDateTime = exports.run = exports.getUrl = exports.saveJson = exports.normalizeJson = exports.loadJson = exports.atomicWrite = exports.link = exports.stall = exports.sha256 = exports.repeat = void 0;
...
function walk(path, func) {
    _walk(path_1.resolve(path), func);
}
exports.walk = walk;
/*
